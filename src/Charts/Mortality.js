...
import SlopeInfantMortality from "../Sections/assets/slope-infant-mortality.svg";
  ...
  return (
    <section>
      <div className="container">
        ...
        {isMobile &&
          <img src={SlopeInfantMortality} alt="Infant mortlity decreased in Sierra Leone, Haiti, Somalia, Angola, and Malawi. It increased in Dominica, Fiji, Saint Lucia, Mauritius, and Brunei" />
        }
        <div className="row">
