...
import GapMobile from "../Sections/assets/gap-mobile.svg";
        ...
        <div className="row">
          <div className="col-12 col-lg-11 offset-lg-1">
            <div id="gap-chart">
              ...
              {isMobile &&
                <img src={GapMobile} alt="The level of literacy for women was 8% lower than men in 2010. In 2020, it was 7%." />
              }
            </div>
          </div>
        </div>
